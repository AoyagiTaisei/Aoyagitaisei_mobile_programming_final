...
class _FridayState extends State<Friday> {
  ...
  void _renderTask() async {
    ...
    setState(() {
      taskList5 = prefs.getStringList('TaskList5') ?? [];
    });
  }
          ...
          children: [
            ElevatedButton(
              onPressed: () async {
                ...
                setState(() {
                  taskList5.add(Task1);
                  prefs.setStringList('TaskList5', taskList5);
                });
              },
              child: Text(
                "新しい課題を入力",
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pop(context, taskList5);
              },
              child: Text(
                "←初期画面へ",
